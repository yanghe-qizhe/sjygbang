...
namespace EOS.WebApp.Areas.CommonModule.Controllers
{
    ...
    public class SysLogController : PublicController<Base_SysLog>
    {
        ...
        /// <returns></returns>
        public ActionResult GridPageListJson(string ModuleId, string ObjectId, string ModuleName, string LogType, string StartTime, string EndTime, string KeyWord, JqGridParam jqgridparam)
        {
            try
            {
                Stopwatch watch = CommonHelper.TimerStart();
                DataTable ListData = base_syslogbll.GetPageList(ModuleId, ObjectId, ModuleName, LogType, StartTime, EndTime, KeyWord, ref jqgridparam);
                var JsonData = new
                {
        ...
        /// </summary>
        /// <returns></returns>
        public ActionResult SysLogQuery()
        {
            return View();
        }
        #region 日志文件
