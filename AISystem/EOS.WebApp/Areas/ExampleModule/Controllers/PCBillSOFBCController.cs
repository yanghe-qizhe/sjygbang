...
{
    public class PCBillSOFBCController : PublicController<DP_POCARSORDER>
    {
        string ModuleId = "";
        ...
        [LoginAuthorize]
        public ActionResult PCBillSOFBC_FORM()
        {
        ...
        [LoginAuthorize]
        public ActionResult PCBillSOFBC_FORM_BZ()
        {
            string KeyValue = Request["KeyValue"];
            ModuleId = Request["ModuleId"];
            if (string.IsNullOrEmpty(KeyValue))
        ...
        //列表
        [LoginAuthorize]
        public ActionResult PCBillSOFBCIndex()
        {
            return View();
        }
        //明细
        [LoginAuthorize]
        public ActionResult PCBillSOFBCDetail()
        {
            return View();
        }
        /// <summary>
        ...
        /// <returns></returns>
        [LoginAuthorize]
        public ActionResult PCBillSOFBCQuery()
        {
            return View();
        }
        ...
        /// <returns></returns>
        [LoginAuthorize]
        public ActionResult SELECTPOORDERSBC()
        {
            return View();
        }
        ...
        //质检汽运
        [LoginAuthorize]
        public ActionResult GetZJOrderList(string BillNo, string PK_ORG, string Supply, string Material, string CarsName, string PK_STORE, string TRAFFICCOMPANY, string PK_ORDER, string WEIGHTNO, string matclass, string DATETYPE, string DEF1,string ISJL, string StartTime, string EndTime, JqGridParam jqgridparam)
        {
            try
            {
                Stopwatch watch = CommonHelper.TimerStart();
                VZJQYBCBll vorderbll = new VZJQYBCBll();
                List<VZJQYBC> ListData = vorderbll.GetOrderList(BillNo, PK_ORG, Supply, Material, CarsName, TRAFFICCOMPANY, PK_STORE, PK_ORDER, WEIGHTNO, matclass, DATETYPE, DEF1, ISJL, StartTime, EndTime, jqgridparam);
                var JsonData = new
                {
                    total = jqgridparam.total,
                    page = jqgridparam.page,
        ...
        public ActionResult GetSQYOrderList(string BillNo, string VBillCode, string PK_ORG, string Supply, string Material, string Cars, string ISUSE, string ISTYPE, string BILLSOFTYPE, string DEF1, string StartTime, string EndTime, JqGridParam jqgridparam)
        {
            try
            {
                ...
                List<VDP_POCARSORDER_DTL> ListData = vorderbll.GetOrderList(BillNo, VBillCode, PK_ORG, Supply, Material, Cars, "", ISUSE, BILLSOFTYPE, ISTYPE, DEF1, StartTime, EndTime, jqgridparam);
                var JsonData = new
                {
                    total = jqgridparam.total,
                    page = jqgridparam.page,
