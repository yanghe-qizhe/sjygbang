...
{
    public class ZJJHZYController : PublicController<QC_ZJJHSEND>
    {
        QC_ZJJHCYBLL bll = new QC_ZJJHCYBLL();
        VQC_ZJJHCYBLL vbll = new VQC_ZJJHCYBLL();
        #region 页面返回
        public ActionResult ZJJHZYList()
        {
            return View();
        }
        public ActionResult ZJJHZYAddCY()
        {
            return View();
        }
        public ActionResult ZJJHZYSelect()
        {
            return View();
        }
        ...
        /// <returns></returns>
        [LoginAuthorize]
        public ActionResult GetJHZYList(string BILLNO, string StartTime, string EndTime, string ISSEND, JqGridParam jqgridparam)
        {
            try
            {
                Stopwatch watch = CommonHelper.TimerStart();
                List<VQC_ZJJHCY> ListData = vbll.GetOrderListForZY(BILLNO, StartTime, EndTime, ISSEND, jqgridparam);
                var JsonData = new
                {
        ...
        /// <returns></returns>
        [LoginAuthorize]
        public ActionResult GetJHZYSelectList(string BILLNO, string StartTime, string EndTime, JqGridParam jqgridparam)
        {
            try
            {
                Stopwatch watch = CommonHelper.TimerStart();
                List<VQC_ZJJHCY> ListData = vbll.GetOrderListForZYSelect(BILLNO, StartTime, EndTime, jqgridparam);
                var JsonData = new
                {
                    total = jqgridparam.total,
                    page = jqgridparam.page,
        ...
        /// <returns></returns>
        [LoginAuthorize]
        public ActionResult JHZJFASendSave(string PCRAWZJFA)
        {
            try
            {
                ResultMessage message = new ResultMessage();
